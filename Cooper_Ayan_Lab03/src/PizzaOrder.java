...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      } else 
      {
    	  inches = 12;
    	  cost = 12.99;
    	  System.out.println("Your choice was not an option, so a 12 inch " +
    			  			"pizza will be made instead.");
      }
      ...
      switch (crustType) {
      	...
      	case 'd':
      		...
      		break;
      	default:
      		System.out.println("This choice is not listed here. A Hand-tossed " + 
      		"crust pizza will be made instead.");
      }
